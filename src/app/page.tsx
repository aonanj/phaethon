          ...
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <div className="border-t border-gray-200 pt-6 mb-6">
              ...
              <p className="text-lg text-[#102A43] mb-4 leading-relaxed">
                Phaethon Order LLC is the sole owner and operator of Spurly, a context-aware AI-powered assistant with direct linking to dating and messaging apps. Spurly helps you find your own words, faster. 
              </p>
